...
def detect_helmets(frame):
    ...
    for result in results_helmet.boxes.data.tolist():
        ...
        if score > 0.75:
            ...
            # Beep alarm for helmet detection
...
def setup_gui():
    ...
    root.title("GLASSES DETECTION SYSTEM **PEGASUS HELMETGUARD**")
    ...
    title_label = ttk.Label(root, text="GLASSES DETECTION SYSTEM **PEGASUS HELMETGUARD**", font=("Helvetica", 16))
    title_label.pack(pady=10)

    instructions_label = ttk.Label(root, text="Click 'Run Program' to start the glasses detection system.", font=("Helvetica", 12))
